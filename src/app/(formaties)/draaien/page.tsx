...
const Page: React.FC = () => {
  return (
    <div className="flex flex-col w-full">
      ...
      <p className="mb-4">
        De voorste renners van een groep zullen een stuk harder moeten trappen omdat ze ‘in de wind
        rijden’. Afhankelijk van waar de wind vandaan komt kan dit wel 30% schelen. Om het kopwerk
        te verdelen roteren we elke paar minuten. Wanneer je moe bent en vooraan komt, mag je je
        ‘kopbeurt’ zo kort maken als je wilt, dit is geen enkel probleem aangezien dit een goeie
        manier is om niveau verschillen te ondervangen.
      </p>
      ...
      <div className="flex">
        ...
        <div className="">
          ...
          <p className="mb-4 text-sm text-zinc-700">
            De renner die rechts achteraan rijdt versneld ook iets en schuift op naar de linker rij
            en daarna 2 plaatsen naar voren.
          </p>
          <p className="mb-4 text-sm text-zinc-700">
      ...
      <p className="mb-4">
        Dit doen we niet vaak, maar wanneer we efficienter op een hoger tempo willen rijden, gaan we
        soms in een enkele rij fietsen: ‘op een lint’.
      </p>
      <p className="mb-4">
        Dit is anders dan het op een lint rijden na het risten, waarbij er niet gedraaid zal worden.
      </p>
