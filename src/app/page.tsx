...
export default function Home() {
  return (
    <div>
      ...
      <p className="mb-4">
        Wanneer je in een groep rijdt ben je je minder bewust van je omgeving doordat je minder ziet
        en vaak ook met mensen aan praten bent. Dat compenseren we door op een voorspelbare manier
        te handelen en communiceren. Dat is veiliger en rijdt ook meer ontspannen.
      </p>
      <p className="mb-4">
        Daarnaast maakt dit ons als groep een meer attente verkeersdeelnemer waarmee we het slechte
        imago van de wielrenner –terecht of onterecht– wellicht kunnen helpen ombuigen.
      </p>
      <section>
