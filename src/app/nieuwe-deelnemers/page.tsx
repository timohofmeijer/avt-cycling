  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <p className="mb-4">
        ...
        koolhydraten (suiker) en vocht tot je neemt. Met name bij langere ritten maakt dit een enorm
        verschil voor intensiteit die je vast kan houden.
      </p>
      ...
      <p className="mb-4">
        Probeer je voorwiel niet voorbij het achterwiel van je voorganger te laten komen wanneer je
        achter iemand rijdt. Wanneer je voorwiel uit lijn wordt geduwd door het achterwiel van je
        voorganger, is een valpartij bijna niet te vermijden (omdat jij en je fiets de andere kant
        op gaan).
      </p>
    </div>
  )
